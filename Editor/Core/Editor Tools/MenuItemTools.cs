...
namespace Lost
{
    ...
    public static class MenuItemTools
    {
        ...
        [MenuItem("Tools/Lost/Actions/Fix Bad Line Endings")]
        ...
        [MenuItem("Tools/Lost/Actions/Convert all C# files to project line endings")]
        public static void ConvertAllCSharpFileLineEndings()
        {
            foreach (string file in Directory.GetFiles(".", "*.cs", SearchOption.AllDirectories))
            {
                ...
                FileUtil.CopyFile(fileName, fileName, true);
            }
        }

        [MenuItem("Tools/Lost/Actions/Create Warnings As Errors File")]
        ...
        [MenuItem("Tools/Lost/Actions/Remove Warnings As Errors")]
