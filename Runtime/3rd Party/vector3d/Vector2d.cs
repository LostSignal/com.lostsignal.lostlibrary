//-----------------------------------------------------------------------
// <copyright file="Vector2d.cs" company="Lost Signal LLC">
...
namespace UnityEngine
{
    public struct Vector2d
    {
        ...
        // NOTE [bgish]: This function added by bgish
        public Vector2d Rotate(double degrees)
        {
            double sin = Math.Sin(degrees * Mathd.Deg2Rad);
            double cos = Math.Cos(degrees * Mathd.Deg2Rad);
