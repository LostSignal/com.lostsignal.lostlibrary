...
namespace Lost
{
    ...
    public class Input
    {
        ...
        ///
        /// Example:
        ///   bool didFingerMove = (input.PreviousPosition - input.CurrentPosition).sqrMagnatude > Input.GetMinimumPixelMovementSquared();.
        ///
        /// </summary>
        ...
        /// <param name="center">The center point of the two inputs.</param>
