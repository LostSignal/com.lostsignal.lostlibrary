...
namespace Lost
{
        ...
        where T : MonoBehaviour
    {
        ...
        // TODO [bgish]: Add Both, this should be possible one day. It could probably work if you set a min/max column/row value.
        ...
        {
            get { return this.topDistance; }
        }

        protected float BottomDistance
        {
            get { return this.bottomDistance; }
        }
        ...
        /// </summary>
        /// <param name="itemCount">The number of items to shift by.</param>
        public void ShiftContent(int itemCount)
        {
            if (this.growType == GrowType.Vertically)
            {
                this.itemContainer.localPosition = this.itemContainer.localPosition.AddToY((this.cellSize.y + this.cellSpacing.y) * -itemCount);
            }
            else
            {
                this.itemContainer.localPosition = this.itemContainer.localPosition.AddToX((this.cellSize.x + this.cellSpacing.x) * -itemCount);
            }
        }
        ...
        protected virtual void Awake()
        {
            ...
            Lost.Localization.Localization.OnLanguagedChanged += this.ReplaceAllVisibleTiles;
        }
